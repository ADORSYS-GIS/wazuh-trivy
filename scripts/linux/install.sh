...
TRIVY_SCAN_SCRIPT_URL=${TRIVY_SCAN_SCRIPT_URL:-"https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-trivy/refs/heads/refactor/split-linux-macos-scripts/scripts/linux/trivy-scan.sh"}
