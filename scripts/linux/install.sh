...
setup_trivy_scan_script() {
    ...
    download_and_verify_file "$TRIVY_SCAN_SCRIPT_URL" "$TRIVY_SCAN_SCRIPT_PATH" "scripts/linux/trivy-scan.sh" "trivy-scan.sh" "${WAZUH_TRIVY_REPO_URL}/checksums.sha256" "$TMP_DIR/checksums.sha256"
