...
setup() {
    ...
    if [ "$(uname)" = "Darwin" ]; then
        ...
        export INSTALL_SCRIPT="./scripts/macos/install.sh"
    else
        ...
        export INSTALL_SCRIPT="./scripts/linux/install.sh"
    fi
    ...
    export WAZUH_TRIVY_REPO_REF="refactor/split-linux-macos-scripts"
}
